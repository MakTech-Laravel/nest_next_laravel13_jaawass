...
<head>
    ...
    <title>{{ __('mail.manufacturer_first_payment_reminder.subject') }}</title>
    <!--[if mso]>
    <noscript>
        <xml>
...
<body
    ...
    <span
        style="display:none !important;visibility:hidden;mso-hide:all;font-size:1px;color:#F0F0F0;line-height:1px;max-height:0;max-width:0;opacity:0;overflow:hidden;">{{ __('mail.manufacturer_first_payment_reminder.preheader') }}</span>
                            ...
                            <table role="presentation" width="100%" cellspacing="0" cellpadding="0" border="0">
                                <tr>
                                    ...
                                    <td align="right" valign="middle">
                                        <span
                                            style="display:inline-block;padding:4px 12px;border-radius:20px;border:1.5px solid #E6E6E6;background-color:#F8F8F8;font-weight:700;font-size:9px;line-height:1;font-family:Arial,Helvetica,sans-serif;letter-spacing:0.4px;text-transform:uppercase;color:#8A8A8A;">{{ __('mail.manufacturer_first_payment_reminder.badge') }}</span>
                                    </td>
                                </tr>
                            </table>
                        </td>
                                ...
                                <tr>
                                    <td valign="top" style="padding-right:12px;">
                                                    ...
                                                    <table role="presentation" cellspacing="0" cellpadding="0"
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td valign="middle"
                                                                ...
                                                                {{ __('mail.manufacturer_first_payment_reminder.pill') }}</td>
                                                        </tr>
                                                    </table>
                                                </td>
                                            </tr>
                                        ...
                                        <div
                                            ...
                                            {!! __('mail.manufacturer_first_payment_reminder.hero_headline') !!}
                                        </div>
                                        <div
                                            ...
                                            {{ __('mail.manufacturer_first_payment_reminder.hero_subheadline') }}</div>
                                    </td>
                    ...
                    <tr>
                        <td bgcolor="#FFFFFF"
                            ...
                            <div
                                ...
                                {{ __('mail.manufacturer_first_payment_reminder.greeting', ['name' => $recipientName]) }}
                            </div>
                            <div
                                ...
                                {!! __('mail.manufacturer_first_payment_reminder.intro') !!}
                            </div>
                                        ...
                                        <table role="presentation" cellspacing="0" cellpadding="0" border="0">
                                            <tr>
                                                ...
                                                <td valign="middle"
                                                    ...
                                                    {{ __('mail.manufacturer_first_payment_reminder.status_label') }}</td>
                                            </tr>
                                        </table>
                                    </td>
                                </tr>
                            ...
                            <table role="presentation" cellspacing="0" cellpadding="0" border="0">
                                <tr>
                                    <td align="center" bgcolor="#9A7A3A" style="border-radius:8px;background-color:#9A7A3A;">
                                        <a href="{{ $ctaUrl }}"
                                            style="display:inline-block;padding:14px 30px;background-color:#9A7A3A;color:#FFFFFF;font-weight:900;font-size:12px;line-height:1;font-family:Arial,Helvetica,sans-serif;letter-spacing:0.6px;text-transform:uppercase;text-decoration:none;border-radius:8px;">{{ __('mail.manufacturer_first_payment_reminder.cta') }}</a>
                                    </td>
                                </tr>
                            </table>
                            <a href="{{ $detailsUrl }}"
                                style="display:block;margin-top:10px;font-weight:600;font-size:12.5px;line-height:1;font-family:Arial,Helvetica,sans-serif;color:#B4B4B4;text-decoration:none;">{{ __('mail.manufacturer_first_payment_reminder.cta_secondary') }}</a>
                            <div
                                ...
                                {!! __('mail.manufacturer_first_payment_reminder.cta_note', ['closeUrl' => e($closeAccountUrl)]) !!}
                            </div>
                        </td>
                    </tr>
                            ...
                            <table role="presentation" width="100%" cellspacing="0" cellpadding="0" border="0">
                                <tr>
                                    ...
                                    <td align="right"
                                        ...
                                        {{ __('mail.manufacturer_first_payment_reminder.footer_tag') }}</td>
                                </tr>
                            </table>
                            <table role="presentation" width="100%" cellspacing="0" cellpadding="0" border="0"
                                style="margin:10px 0;">
