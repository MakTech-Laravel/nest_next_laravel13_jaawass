@php
    ...
    $recipientName = trim((string) ($recipientName ?? $buyerName ?? '')) !== ''
        ? trim((string) ($recipientName ?? $buyerName ?? ''))
        : 'there';
...
<head>
    ...
    <title>Your review was approved — {{ $productName !== '' ? $productName : $platformName }}</title>
    <!--[if mso]>
    <noscript>
        <xml>
...
<body style="margin:0;padding:0;background-color:#F4F0EA;font-family:Arial,Helvetica,sans-serif;-webkit-text-size-adjust:100%;-ms-text-size-adjust:100%;">
    <div style="display:none;font-size:1px;line-height:1px;max-height:0;max-width:0;opacity:0;overflow:hidden;mso-hide:all;">
        Your review was approved and is now published on sourceNest.&nbsp;&zwnj;&nbsp;&zwnj;&nbsp;&zwnj;&nbsp;&zwnj;&nbsp;&zwnj;&nbsp;&zwnj;&nbsp;&zwnj;&nbsp;&zwnj;&nbsp;&zwnj;&nbsp;&zwnj;
    </div>
                                ...
                                <tr>
                                    <td class="email-stack email-stack-icon" width="76" valign="middle" style="width:76px;padding-right:18px;">
                                        <table role="presentation" cellspacing="0" cellpadding="0" border="0">
                                            <tr>
                                                <td width="58" height="58" align="center" valign="middle" bgcolor="#0E8A4A"
                                                    style="width:58px;height:58px;background-color:#0E8A4A;border:1.5px solid #0E8A4A;border-radius:14px;">
                                    ...
                                    <td class="email-stack" valign="middle">
                                            ...
                                            <tr>
                                                <td>
                                                    <span style="display:inline-block;padding:4px 11px;border-radius:20px;border:1.5px solid #6ECFA0;background-color:#EAFAF2;">
                                                        ...
                                                        <span style="font-weight:800;font-size:8.5px;line-height:1;font-family:Arial,Helvetica,sans-serif;letter-spacing:1.2px;text-transform:uppercase;color:#666666;vertical-align:middle;">Review Approved</span>
                                                    </span>
                                                </td>
                                            </tr>
                                        </table>
                                        <div class="email-hero-title"
                                            ...
                                            Your review has been <em style="font-style:italic;color:#9A7A3A;">approved.</em>
                                        </div>
                                        <div style="padding-top:6px;font-weight:400;font-size:13px;line-height:1.78;font-family:Arial,Helvetica,sans-serif;color:#666666;">
                                            Hello {{ $recipientName }} — your review is now published on sourceNest.
                                        </div>
                                    </td>
                                </tr>
                            </table>
                        ...
                        <td class="email-pad" bgcolor="#FFFFFF" style="padding:28px 30px;background-color:#FFFFFF;border-bottom:1px solid #F0F0F0;">
                            <table role="presentation" cellspacing="0" cellpadding="0" border="0" style="margin-bottom:18px;">
                                <tr>
                                    ...
                                    <td style="padding-left:9px;font-weight:500;font-size:17px;line-height:1;font-family:Georgia,'Times New Roman',serif;color:#3B2800;">Published review</td>
                                </tr>
                            </table>
                                    ...
                                    <td bgcolor="#F8F8F8" style="padding:11px 16px;background-color:#F8F8F8;border-bottom:1px solid #E6E6E6;">
                                        <table role="presentation" width="100%" cellspacing="0" cellpadding="0" border="0">
                                            <tr>
                                                ...
                                                <td align="right">
                                                    <span style="display:inline-block;padding:2px 10px;border-radius:20px;border:1.5px solid #6ECFA0;background-color:#EAFAF2;font-weight:800;font-size:9px;line-height:1;font-family:Arial,Helvetica,sans-serif;color:#0A5C32;">Published</span>
                                                </td>
                                            </tr>
                                        </table>
                                    </td>
                                    ...
                                    <tr>
                                        <td style="padding:0;">
                                            <table role="presentation" width="100%" cellspacing="0" cellpadding="0" border="0">
                                                <tr>
                                                    <td class="email-evl-lbl" width="110" bgcolor="#F8F8F8" valign="middle"
                                                        style="width:110px;padding:11px 16px;background-color:#F8F8F8;border-top:1px solid #F0F0F0;border-right:1px solid #F0F0F0;font-weight:700;font-size:11px;line-height:1;font-family:Arial,Helvetica,sans-serif;color:#8A8A8A;">Title</td>
                                                    <td class="email-evl-val" valign="middle" style="padding:11px 16px;border-top:1px solid #F0F0F0;font-weight:500;font-size:12.5px;line-height:1.4;font-family:Arial,Helvetica,sans-serif;color:#1C1C1C;">{{ $reviewTitle }}</td>
                                                </tr>
                                            </table>
                                        </td>
                                    </tr>
                            ...
                            <p style="margin:18px 0 0 0;font-weight:400;font-size:13.5px;line-height:1.88;font-family:Arial,Helvetica,sans-serif;color:#464646;">
                                Thank you for sharing your experience. Your review is now live on the product page and helps other buyers make better sourcing decisions.
                            </p>
                        </td>
                    </tr>
                    ...
                    <tr>
                        <td class="email-pad" bgcolor="#FFFFFF" style="padding:26px 30px 30px;background-color:#FFFFFF;">
                                ...
                                <tr>
                                    <td bgcolor="#3B2800" style="border-radius:8px;background-color:#3B2800;">
                                        <a class="email-cta" href="{{ $ctaUrl }}"
                                            style="display:inline-block;padding:14px 30px;background-color:#3B2800;color:#FFFFFF;font-weight:900;font-size:12px;line-height:1;font-family:Arial,Helvetica,sans-serif;letter-spacing:0.6px;text-transform:uppercase;text-decoration:none;border-radius:8px;">View Your Review</a>
                                    </td>
                                </tr>
                            </table>
                            <p style="margin:18px 0 0 0;padding-top:18px;border-top:1px solid #F0F0F0;font-weight:400;font-size:12px;line-height:1.75;font-family:Arial,Helvetica,sans-serif;color:#8A8A8A;">
                                Log in to sourceNest to see your published review on the product page.
                            </p>
                        </td>
                    </tr>
