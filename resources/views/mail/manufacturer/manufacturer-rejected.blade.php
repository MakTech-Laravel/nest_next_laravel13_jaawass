@php
    ...
    $reasonSteps = [
        [
            ...
            'body' => __('mail.manufacturer_rejected.reason_step_1_body'),
        ],
        [
            'title' => __('mail.manufacturer_rejected.reason_step_2_title'),
            'body' => __('mail.manufacturer_rejected.reason_step_2_body'),
        ],
        [
            'title' => __('mail.manufacturer_rejected.reason_step_3_title'),
            'body' => __('mail.manufacturer_rejected.reason_step_3_body'),
        ],
    ];
@endphp
<!DOCTYPE html>
...
<head>
    ...
    <title>{{ __('mail.manufacturer_rejected.subject') }}</title>
    <!--[if mso]>
    <noscript>
        <xml>
...
<body
    ...
    <span
        style="display:none !important;visibility:hidden;mso-hide:all;font-size:1px;color:#F0F0F0;line-height:1px;max-height:0;max-width:0;opacity:0;overflow:hidden;">{{ __('mail.manufacturer_rejected.preheader') }}</span>
                            ...
                            <table role="presentation" width="100%" cellspacing="0" cellpadding="0" border="0">
                                <tr>
                                    ...
                                    <td align="right" valign="middle">
                                        <span
                                            style="display:inline-block;padding:4px 12px;border-radius:20px;border:1.5px solid #E6E6E6;background-color:#F8F8F8;font-weight:700;font-size:9px;line-height:1;font-family:Arial,Helvetica,sans-serif;letter-spacing:0.4px;text-transform:uppercase;color:#8A8A8A;">{{ __('mail.manufacturer_rejected.badge') }}</span>
                                    </td>
                                </tr>
                            </table>
                        </td>
                    ...
                    <tr>
                        <td bgcolor="#F8F8F8"
                                        ...
                                        <table role="presentation" cellspacing="0" cellpadding="0" border="0">
                                            <tr>
                                                ...
                                                <td valign="middle"
                                                    ...
                                                    {{ __('mail.manufacturer_rejected.pill') }}</td>
                                            </tr>
                                        </table>
                                    </td>
                                </tr>
                            ...
                            <div
                                ...
                                {{ __('mail.manufacturer_rejected.hero_subheadline') }}</div>
                        </td>
                    </tr>
                    ...
                    <tr>
                        <td bgcolor="#FFFFFF"
                            ...
                            <div
                                ...
                                {{ __('mail.manufacturer_rejected.greeting', ['name' => $recipientName]) }}</div>
                            <p
                            ...
                            @if ($rejectionReason !== '')
                                <table role="presentation" width="100%" cellspacing="0" cellpadding="0" border="0"
                                    style="margin-top:16px;background-color:#FEF2F2;border:1.5px solid #EEAAAA;border-left:4px solid #7A1818;border-radius:8px;border-collapse:separate;">
                                    <tr>
                                        <td style="padding:14px 16px;">
                                            <div
                                                style="font-weight:900;font-size:8.5px;line-height:1;font-family:Arial,Helvetica,sans-serif;letter-spacing:1.6px;text-transform:uppercase;color:#7A1818;margin-bottom:5px;">
                                                {{ __('mail.manufacturer_rejected.message_heading') }}</div>
                                            <div
                            ...
                            {{-- Status chip --}}
                            <table role="presentation" width="100%" cellspacing="0" cellpadding="0" border="0"
                                style="margin-top:16px;background-color:#FEF2F2;border:1.5px solid #EEAAAA;border-radius:8px;border-collapse:separate;">
                                <tr>
                                        ...
                                        <table role="presentation" width="100%" cellspacing="0" cellpadding="0"
                                            ...
                                            <tr>
                                                    ...
                                                    <table role="presentation" cellspacing="0" cellpadding="0"
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td valign="middle"
                                                                ...
                                                                {{ __('mail.manufacturer_rejected.status_label') }}
                                                            </td>
                                                        </tr>
                                                    </table>
                                                </td>
                                                <td align="right" valign="middle"
                                                    ...
                                                    {{ __('mail.manufacturer_rejected.status_date', ['date' => $decisionDate]) }}
                                                </td>
                                            </tr>
                                        </table>
                                    </td>
                            ...
                            <table role="presentation" width="100%" cellspacing="0" cellpadding="0" border="0"
                                style="margin-top:14px;background-color:#FEF2F2;border:1.5px solid #EEAAAA;border-left:4px solid #7A1818;border-radius:8px;border-collapse:separate;">
                                <tr>
                                    <td style="padding:14px 16px;">
                                        <div
                                            style="font-weight:900;font-size:8.5px;line-height:1;font-family:Arial,Helvetica,sans-serif;letter-spacing:1.6px;text-transform:uppercase;color:#7A1818;margin-bottom:5px;">
                                            {{ __('mail.manufacturer_rejected.resubmit_heading') }}</div>
                                        <div
                                            style="font-weight:400;font-size:13px;line-height:1.65;font-family:Arial,Helvetica,sans-serif;color:#464646;">
                                            {{ __('mail.manufacturer_rejected.resubmit_body') }}</div>
                                    </td>
                                </tr>
                            </table>
                        </td>
                            ...
                            <table role="presentation" width="100%" cellspacing="0" cellpadding="0" border="0">
                                <tr>
                                    ...
                                    <td align="right"
                                        ...
                                        {{ __('mail.manufacturer_rejected.footer_tag') }}</td>
                                </tr>
                            </table>
                            <table role="presentation" width="100%" cellspacing="0" cellpadding="0" border="0"
                                style="margin:10px 0;">
