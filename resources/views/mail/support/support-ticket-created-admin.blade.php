@php
    ...
    $creatorInitials = $creatorInitials ?? \App\Support\Mail\MailNotificationHelper::initials($creatorName);
    $submittedAt = $submittedAt ?? '';
    $messageBody = trim(strip_tags((string) ($messageBodyPlain ?? $messageBody ?? '')));
...
<head>
    ...
    <meta name="x-apple-disable-message-reformatting">
    <title>New support ticket opened — {{ $ticketNumber }}</title>
    <!--[if mso]>
    <noscript>
        <xml>
...
<body style="margin:0;padding:0;background-color:#F4F0EA;font-family:Arial,Helvetica,sans-serif;-webkit-text-size-adjust:100%;-ms-text-size-adjust:100%;">
    <div style="display:none;font-size:1px;line-height:1px;max-height:0;max-width:0;opacity:0;overflow:hidden;mso-hide:all;">
        New support ticket opened — {{ $ticketNumber }}&nbsp;&zwnj;&nbsp;&zwnj;&nbsp;&zwnj;&nbsp;&zwnj;&nbsp;&zwnj;&nbsp;&zwnj;&nbsp;&zwnj;&nbsp;&zwnj;&nbsp;&zwnj;&nbsp;&zwnj;
    </div>
                                ...
                                <tr>
                                    ...
                                    <td class="email-stack" valign="middle">
                                            ...
                                            <tr>
                                                <td>
                                                    <span style="display:inline-block;padding:4px 11px;border-radius:20px;border:1.5px solid #E8D5A8;background-color:#FBF7EE;">
                                                        ...
                                                        <span style="font-weight:800;font-size:8.5px;line-height:1;font-family:Arial,Helvetica,sans-serif;letter-spacing:1.2px;text-transform:uppercase;color:#666666;vertical-align:middle;">New Ticket</span>
                                                    </span>
                                                </td>
                                            </tr>
                                        </table>
                                        <div class="email-hero-title"
                                            ...
                                            A new support ticket <em style="font-style:italic;color:#9A7A3A;">has been opened.</em>
                                        </div>
                                        <div style="padding-top:6px;font-weight:400;font-size:13px;line-height:1.78;font-family:Arial,Helvetica,sans-serif;color:#666666;">
                                            A user has submitted a support request on sourceNest. Please review and respond.
                                        </div>
                                    </td>
                                </tr>
                            </table>
                        ...
                        <td class="email-pad" bgcolor="#FFFFFF" style="padding:28px 30px;background-color:#FFFFFF;border-bottom:1px solid #F0F0F0;">
                            <table role="presentation" cellspacing="0" cellpadding="0" border="0" style="margin-bottom:18px;border-collapse:separate;">
                                <tr>
                                    ...
                                    <td style="padding-left:9px;font-weight:500;font-size:17px;line-height:1;font-family:Georgia,'Times New Roman',serif;color:#3B2800;">Ticket details</td>
                                </tr>
                            </table>
                                    ...
                                    <td bgcolor="#F8F8F8" style="padding:11px 16px;background-color:#F8F8F8;border-bottom:1px solid #E6E6E6;">
                                        <table role="presentation" width="100%" cellspacing="0" cellpadding="0" border="0">
                                            <tr>
                                                ...
                                                <td align="right">
                                                    <span style="display:inline-block;padding:2px 10px;border-radius:20px;border:1.5px solid #D6D6D6;background-color:#F8F8F8;font-weight:800;font-size:9px;line-height:1;font-family:Arial,Helvetica,sans-serif;color:#464646;">Open</span>
                                                </td>
                                            </tr>
                                        </table>
                                    </td>
                            ...
                            <table role="presentation" width="100%" cellspacing="0" cellpadding="0" border="0"
                                ...
                                <tr>
                                    <td bgcolor="#F8F8F8" style="padding:11px 16px;background-color:#F8F8F8;border-bottom:1px solid #E6E6E6;">
                                        <span style="font-weight:900;font-size:9px;line-height:1;font-family:Arial,Helvetica,sans-serif;letter-spacing:1.2px;text-transform:uppercase;color:#8A8A8A;">Submitted by</span>
                                    </td>
                                </tr>
                                @foreach ([
                                    ['Name', $creatorName],
                                    ['Account type', $creatorType],
                                    ['Email', $creatorEmail],
                                ] as [$label, $value])
                                    @if (trim((string) $value) !== '')
                                        <tr>
                        ...
                        <tr>
                            <td class="email-pad" bgcolor="#F8F8F8" style="padding:28px 30px;background-color:#F8F8F8;border-bottom:1px solid #F0F0F0;">
                                <table role="presentation" cellspacing="0" cellpadding="0" border="0" style="margin-bottom:18px;border-collapse:separate;">
                                    <tr>
                                        <td width="3" bgcolor="#E8D5A8" style="width:3px;height:18px;background-color:#E8D5A8;border-radius:2px;font-size:0;line-height:0;">&nbsp;</td>
                                        <td style="padding-left:9px;font-weight:500;font-size:17px;line-height:1;font-family:Georgia,'Times New Roman',serif;color:#3B2800;">Message</td>
                                    </tr>
                                </table>
                                ...
                                <table role="presentation" width="100%" cellspacing="0" cellpadding="0" border="0"
                                            ...
                                            <table role="presentation" width="100%" cellspacing="0" cellpadding="0" border="0">
                                                <tr>
                                                    <td width="38" valign="middle" style="width:38px;padding-right:12px;">
                                                        <div style="width:38px;height:38px;background-color:#3B2800;border-radius:8px;text-align:center;line-height:38px;font-weight:600;font-size:14px;font-family:Georgia,'Times New Roman',serif;color:#C8A96A;">{{ $creatorInitials }}</div>
                                                    </td>
                                                    <td valign="middle">
                                                        <div style="font-weight:800;font-size:13.5px;line-height:1;font-family:Arial,Helvetica,sans-serif;color:#3B2800;">{{ $creatorName !== '' ? $creatorName : 'User' }}</div>
                                                        <div style="font-weight:500;font-size:11.5px;line-height:1;font-family:Arial,Helvetica,sans-serif;color:#8A8A8A;margin-top:4px;">{{ $creatorType }} · sourceNest</div>
                                                    </td>
                                                    @if ($submittedAt !== '')
                                                        <td align="right" valign="middle" style="font-weight:500;font-size:11px;line-height:1;font-family:Arial,Helvetica,sans-serif;color:#B4B4B4;">{{ $submittedAt }}</td>
                                                    @endif
                                                </tr>
                                            </table>
                                        </td>
                                    ...
                                    <tr>
                                        <td style="padding:17px 19px;">
                                            <p style="margin:0;font-weight:400;font-size:13.5px;line-height:1.88;font-family:Arial,Helvetica,sans-serif;color:#464646;">{{ $messageBody }}</p>
                                        </td>
                                    </tr>
                                </table>
                            </td>
                    ...
                    <tr>
                        <td class="email-pad" bgcolor="#FFFFFF" style="padding:26px 30px 30px;background-color:#FFFFFF;">
                            ...
                            <p style="margin:18px 0 0 0;padding-top:18px;border-top:1px solid #F0F0F0;font-weight:400;font-size:12px;line-height:1.75;font-family:Arial,Helvetica,sans-serif;color:#8A8A8A;">
                                Log in to the admin panel to review and respond to this ticket.
                            </p>
                        </td>
                    </tr>
