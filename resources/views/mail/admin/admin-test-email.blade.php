...
<head>
    ...
    <title>{{ __('mail.admin_test_email.subject') }}</title>
    <!--[if mso]>
    <noscript>
        <xml>
...
<body style="margin:0;padding:0;background-color:#ede7d9;font-family:Arial,Helvetica,sans-serif;-webkit-text-size-adjust:100%;-ms-text-size-adjust:100%;">
    <span style="display:none !important;visibility:hidden;mso-hide:all;font-size:1px;color:#ede7d9;line-height:1px;max-height:0;max-width:0;opacity:0;overflow:hidden;">
        {{ __('mail.admin_test_email.preheader') }}
    </span>
                    ...
                    <tr>
                        <td align="center" bgcolor="#2c2517" style="padding:40px 40px 24px 40px;background-color:#2c2517;">
                            ...
                            <p style="margin:0 0 8px 0;font-size:9.5px;font-weight:500;letter-spacing:0.22em;text-transform:uppercase;color:#d4bc8a;opacity:0.65;font-family:Arial,Helvetica,sans-serif;">
                                {{ __('mail.layout.default_eyebrow') }}
                            </p>
                            <h1 style="margin:0 0 8px 0;font-family:Georgia,'Times New Roman',serif;font-size:34px;font-weight:400;color:#f5f0e8;line-height:1.2;">
                                {{ __('mail.admin_test_email.header_title') }}
                            </h1>
                            <p style="margin:0;font-family:Georgia,'Times New Roman',serif;font-style:italic;font-size:14px;color:#d4bc8a;opacity:0.8;">
                                {{ __('mail.admin_test_email.header_subtitle') }}
                            </p>
                        </td>
                    </tr>
                    <tr>
                        <td bgcolor="#f5f0e8" style="padding:24px 40px 40px 40px;background-color:#f5f0e8;">
                            <p style="margin:0 0 16px 0;font-size:15px;line-height:1.6;color:#2c2517;font-family:Arial,Helvetica,sans-serif;">
                                {{ __('mail.admin_test_email.greeting', ['name' => $recipient_name ?? 'Admin']) }}
                            </p>
                            <p style="margin:0 0 16px 0;font-size:14px;line-height:1.7;color:#7a6e5a;font-family:Arial,Helvetica,sans-serif;">
                                {{ __('mail.admin_test_email.intro', ['platform' => $platform_name ?? config('app.name')]) }}
                            </p>
                            <p style="margin:0;font-size:14px;line-height:1.7;color:#7a6e5a;font-family:Arial,Helvetica,sans-serif;">
