                    ...
                    <tr>
                        <td style="padding:28px 28px 12px 28px;background-color:#111827;">
                            ...
                            <h1 style="margin:0;font-size:24px;line-height:1.3;font-weight:600;color:#f8fafc;">
                                {{ __('mail.manufacturer_additional_information.subject') }}
                            </h1>
                        </td>
                    </tr>
                    <tr>
                        <td style="padding:28px;">
                            ...
                            <p style="margin:0 0 24px 0;font-size:15px;line-height:1.6;color:#374151;">
                                {{ __('mail.manufacturer_additional_information.intro', ['company' => $companyName]) }}
                            </p>
                            ...
                            @if (!empty($allowedTypes))
                                <p style="margin:24px 0 12px 0;font-size:13px;font-weight:700;color:#111827;">
                                ...
                                <ul style="margin:0 0 24px 0;padding-left:20px;color:#374151;font-size:14px;line-height:1.8;">
                                    @foreach ($allowedTypes as $typeLabel)
                                        <li>{{ $typeLabel }}</li>
                                    @endforeach
                                </ul>
                            @endif
                            ...
                            <table role="presentation" cellspacing="0" cellpadding="0" border="0" style="margin:0 0 24px 0;">
                                <tr>
                                    <td style="border-radius:8px;background-color:#1d4ed8;">
                                        <a href="{{ $submissionUrl }}" style="display:inline-block;padding:14px 24px;font-size:15px;font-weight:600;color:#ffffff;text-decoration:none;">
