@php
    ...
    $endsAt = $endsAt ?? now()->format('F j, Y');
@endphp
<!DOCTYPE html>
...
<body class="body email-body" bgcolor="#F0F0F0" style="margin:0;padding:0;background-color:#F0F0F0 !important;color:#1C1C1C;font-family:Arial,Helvetica,sans-serif;-webkit-text-size-adjust:100%;-ms-text-size-adjust:100%;">
    <span style="display:none !important;visibility:hidden;mso-hide:all;font-size:1px;color:#F0F0F0;line-height:1px;max-height:0;max-width:0;opacity:0;overflow:hidden;">
        Your plan is paused until you renew.
    </span>
                            ...
                            <table role="presentation" width="100%" cellspacing="0" cellpadding="0" border="0">
                                <tr>
                                    ...
                                    <td align="right" style="vertical-align:middle;">
                                        <span style="display:inline-block;font:700 9px/1 Arial,Helvetica,sans-serif;letter-spacing:0.4px;text-transform:uppercase;padding:4px 12px;border-radius:20px;color:#C42828;background-color:#FEF2F2;border:1px solid #EEAAAA;">Subscription Ended</span>
                                    </td>
                                </tr>
                            </table>
                        </td>
                    ...
                    <tr>
                        <td class="email-pad email-cell-gray" bgcolor="#F8F8F8" style="background-color:#F8F8F8 !important;padding:26px 30px 24px;border-bottom:1px solid #E6E6E6;">
                            <table role="presentation" cellspacing="0" cellpadding="0" border="0" style="margin:0 0 14px 0;border-collapse:separate !important;">
                                <tr>
                                    <td bgcolor="#FEF2F2" style="background-color:#FEF2F2;border:1px solid #EEAAAA;border-radius:20px;padding:4px 11px;">
                                        ...
                                        <span style="font:800 8.5px/1 Arial,Helvetica,sans-serif;letter-spacing:1.2px;text-transform:uppercase;color:#7A1818;vertical-align:middle;">Access Paused</span>
                                    </td>
                                </tr>
                            </table>
                            <div class="email-ht email-text-strong" style="font:500 25px/1.17 Georgia,'Times New Roman',serif;color:#1C1C1C !important;letter-spacing:-0.2px;">
                                Your subscription has<br><em style="font-style:italic;color:#9A7A3A;">ended.</em>
                            </div>
                            <div class="email-muted" style="margin-top:12px;font:400 13px/1.78 Arial,Helvetica,sans-serif;color:#666666 !important;">
                                Your plan is paused until you renew. Complete payment to restore full access.
                            </div>
                        </td>
                    </tr>
                    ...
                    <tr>
                        <td class="email-pad email-cell-white" bgcolor="#FFFFFF" style="background-color:#FFFFFF !important;padding:28px 30px;border-bottom:1px solid #F0F0F0;">
                            ...
                            <p class="email-text" style="margin:0 0 13px 0;font:400 13.5px/1.88 Arial,Helvetica,sans-serif;color:#464646 !important;">
                                Your <strong class="email-text-strong" style="font-weight:700;color:#1C1C1C !important;">{{ $planName }}</strong> subscription ended on <strong class="email-text-strong" style="font-weight:700;color:#1C1C1C !important;">{{ $endsAt }}</strong>. Your account is paused until you complete payment — once you renew, your plan benefits will be restored automatically.
                            </p>
                                        ...
                                        <table role="presentation" width="100%" cellspacing="0" cellpadding="0" border="0">
                                            <tr>
                                                <td style="vertical-align:middle;">
                                                    ...
                                                    <span class="email-text-strong" style="font:700 12.5px/1 Arial,Helvetica,sans-serif;color:#1C1C1C !important;vertical-align:middle;">Subscription ended — access paused</span>
                                                </td>
                            ...
                            <table role="presentation" width="100%" cellspacing="0" cellpadding="0" border="0" bgcolor="#FEF2F2" style="margin-top:14px;background-color:#FEF2F2;border:1px solid #EEAAAA;border-left:4px solid #7A1818;border-radius:8px;border-collapse:separate !important;">
                                <tr>
                                    <td style="padding:14px 16px;border-radius:8px;">
                                        <div style="font:900 8.5px/1 Arial,Helvetica,sans-serif;letter-spacing:1.6px;text-transform:uppercase;color:#7A1818;margin:0 0 5px 0;">Profile currently hidden</div>
                                        <div class="email-text" style="font:400 13px/1.65 Arial,Helvetica,sans-serif;color:#464646 !important;">
                                            Your supplier profile is <strong class="email-text-strong" style="font-weight:700;color:#1C1C1C !important;">hidden from buyers</strong> and incoming inquiries are suspended until you renew.
                                        </div>
                                    </td>
                                </tr>
                            </table>
                        ...
                        <td class="email-pad email-cell-gray" bgcolor="#F8F8F8" style="background-color:#F8F8F8 !important;padding:28px 30px;border-bottom:1px solid #F0F0F0;">
                            <table role="presentation" cellspacing="0" cellpadding="0" border="0" style="margin:0 0 18px 0;">
                                <tr>
                                    ...
                                    <td class="email-heading" style="padding-left:9px;font:500 17px/1 Georgia,'Times New Roman',serif;color:#3B2800 !important;">
                                        Renewing <em style="font-style:italic;color:#9A7A3A;">restores instantly</em>
                                    </td>
                                </tr>
                            </table>
                            ...
                            <table role="presentation" width="100%" cellspacing="0" cellpadding="0" border="0" style="border-bottom:1px solid #F0F0F0;">
                                <tr>
                                    ...
                                    <td valign="top" style="padding:15px 0;vertical-align:top;">
                                        <div class="email-text-strong" style="font:700 13.5px/1.4 Arial,Helvetica,sans-serif;color:#1C1C1C !important;">Profile visibility to buyers worldwide</div>
                                    </td>
                                </tr>
                            </table>
                            ...
                            <table role="presentation" width="100%" cellspacing="0" cellpadding="0" border="0" style="border-bottom:1px solid #F0F0F0;">
                                <tr>
                                    ...
                                    <td valign="top" style="padding:15px 0;vertical-align:top;">
                                        <div class="email-text-strong" style="font:700 13.5px/1.4 Arial,Helvetica,sans-serif;color:#1C1C1C !important;">Product listings and inquiry inbox access</div>
                                    </td>
                                </tr>
                            </table>
                            ...
                            <table role="presentation" width="100%" cellspacing="0" cellpadding="0" border="0">
                                <tr>
                                    ...
                                    <td valign="top" style="padding:15px 0;vertical-align:top;">
                                        <div class="email-text-strong" style="font:700 13.5px/1.4 Arial,Helvetica,sans-serif;color:#1C1C1C !important;">Full dashboard, messaging, and analytics</div>
                                    </td>
                                </tr>
                            </table>
                        </td>
                        ...
                        <td class="email-pad email-cell-white" bgcolor="#FFFFFF" style="background-color:#FFFFFF !important;padding:26px 30px 30px;border-top:1px solid #F0F0F0;">
                            <table role="presentation" width="100%" cellspacing="0" cellpadding="0" border="0" style="border-collapse:separate !important;">
                                <tr>
                                    <td>
                                        <!--[if mso]>
                                        <v:roundrect xmlns:v="urn:schemas-microsoft-com:vml" href="{{ $ctaUrl }}" style="height:44px;v-text-anchor:middle;width:160px;" arcsize="18%" strokecolor="#3B2800" fillcolor="#3B2800">
                                            <w:anchorlock/>
                                            <center style="color:#FFFFFF;font-family:Arial,Helvetica,sans-serif;font-size:12px;font-weight:bold;letter-spacing:0.6px;">RENEW NOW</center>
                                        </v:roundrect>
                                        <![endif]-->
                                        <!--[if !mso]><!-->
                                        <a href="{{ $ctaUrl }}" style="display:inline-block;padding:14px 30px;background-color:#3B2800;color:#FFFFFF !important;font:900 12px/1 Arial,Helvetica,sans-serif;letter-spacing:0.6px;text-transform:uppercase;text-decoration:none;border-radius:8px;mso-hide:all;">Renew Now</a>
                                        <!--<![endif]-->
                                    </td>
                                </tr>
                                <tr>
                                    <td style="padding-top:14px;">
                                        <div class="email-muted" style="font:400 12px/1.65 Arial,Helvetica,sans-serif;color:#8A8A8A !important;">Need help? Contact our support team.</div>
                                    </td>
                                </tr>
                            </table>
                        </td>
