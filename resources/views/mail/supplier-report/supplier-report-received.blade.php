@php
    ...
    $buyerName = trim((string) ($buyerName ?? '')) !== '' ? trim((string) $buyerName) : 'there';
    $supplierName = $supplierName ?? '';
    $reportId = $reportId ?? '';
    $reasonLabel = $reasonLabel ?? '';
    $messageBody = $messageBody ?? null;
    $referenceId = $referenceId ?? ($reportId !== '' ? 'RPT-'.str_pad((string) $reportId, 5, '0', STR_PAD_LEFT) : '');
    $ctaUrl = $reportsUrl ?? \App\Support\Mail\MailNotificationHelper::frontendUrl('dashboard/buyer/reports');
@endphp
<!DOCTYPE html>
...
<body style="margin:0;padding:0;background-color:#F0F0F0;font-family:'Nunito',Arial,Helvetica,sans-serif;-webkit-text-size-adjust:100%;-ms-text-size-adjust:100%;">
    <span style="display:none !important;visibility:hidden;mso-hide:all;font-size:1px;color:#F0F0F0;line-height:1px;max-height:0;max-width:0;opacity:0;overflow:hidden;">{{ __('mail.supplier_report_received.preheader') }}</span>
                ...
                <table role="presentation" width="600" cellspacing="0" cellpadding="0" border="0"
                            ...
                            <table role="presentation" width="100%" cellspacing="0" cellpadding="0" border="0">
                                <tr>
                                    ...
                                    <td align="right" valign="middle">
                                        <span style="display:inline-block;padding:4px 12px;border-radius:20px;border:1.5px solid #E6E6E6;background-color:#F8F8F8;font-weight:700;font-size:9px;line-height:1;font-family:'Nunito',Arial,Helvetica,sans-serif;letter-spacing:0.4px;text-transform:uppercase;color:#8A8A8A;">{{ __('mail.supplier_report_received.badge') }}</span>
                                    </td>
                                </tr>
                            </table>
                        </td>
                                    ...
                                    <td class="email-stack" valign="middle">
                                        <table role="presentation" cellspacing="0" cellpadding="0" border="0" style="margin-bottom:8px;">
                                            <tr>
                                                ...
                                                <td valign="middle" style="font-weight:800;font-size:8.5px;line-height:1;font-family:'Nunito',Arial,Helvetica,sans-serif;letter-spacing:2px;text-transform:uppercase;color:#9A7A3A;">{{ __('mail.supplier_report_received.pill') }}</td>
                                            </tr>
                                        </table>
                                        <div class="email-hero-title" style="font-weight:500;font-size:22px;line-height:1.17;font-family:'Lora',Georgia,'Times New Roman',serif;color:#3B2800;letter-spacing:-0.2px;">
                                            {!! __('mail.supplier_report_received.hero_headline') !!}
                                        </div>
                                        <div style="padding-top:6px;font-weight:400;font-size:13px;line-height:1.78;font-family:'Nunito',Arial,Helvetica,sans-serif;color:#666666;">{{ __('mail.supplier_report_received.hero_subheadline') }}</div>
                                    </td>
                                </tr>
                            </table>
                        </td>
                    ...
                    <tr>
                        <td class="email-pad" bgcolor="#FFFFFF" style="padding:28px 30px;background-color:#FFFFFF;border-bottom:1px solid #F0F0F0;">
                            <div style="font-weight:500;font-size:17px;line-height:1;font-family:'Lora',Georgia,'Times New Roman',serif;color:#3B2800;margin-bottom:13px;">{{ __('mail.supplier_report_received.greeting', ['name' => $buyerName]) }}</div>
                            <p style="margin:0 0 18px 0;font-weight:400;font-size:13.5px;line-height:1.88;font-family:'Nunito',Arial,Helvetica,sans-serif;color:#464646;">{{ __('mail.supplier_report_received.intro', ['supplier' => $supplierName, 'id' => $reportId]) }}</p>
                            ...
                            <table role="presentation" cellspacing="0" cellpadding="0" border="0" style="margin-bottom:18px;border-collapse:separate;">
                                <tr>
                                    ...
                                    <td style="padding-left:9px;font-weight:500;font-size:17px;line-height:1;font-family:'Lora',Georgia,'Times New Roman',serif;color:#3B2800;">{{ __('mail.supplier_report_received.details_title') }}</td>
                                </tr>
                            </table>
                            ...
                            <table role="presentation" width="100%" cellspacing="0" cellpadding="0" border="0"
                                ...
                                <tr>
                                    <td bgcolor="#F8F8F8" style="padding:11px 16px;background-color:#F8F8F8;border-bottom:1px solid #E6E6E6;">
                                        <table role="presentation" width="100%" cellspacing="0" cellpadding="0" border="0">
                                            <tr>
                                                <td style="font-weight:900;font-size:9px;line-height:1;font-family:'Nunito',Arial,Helvetica,sans-serif;letter-spacing:1.2px;text-transform:uppercase;color:#8A8A8A;">{{ __('mail.supplier_report_received.details_title') }}</td>
                                                <td align="right">
                                                    <span style="display:inline-block;padding:2px 10px;border-radius:20px;border:1.5px solid #F0C040;background-color:#FFF8E4;font-weight:800;font-size:9px;line-height:1;font-family:'Nunito',Arial,Helvetica,sans-serif;color:#7A4D00;">{{ __('mail.supplier_report_received.status_badge') }}</span>
                                                </td>
                                            </tr>
                                        </table>
                                    </td>
                                ...
                                @foreach ([
                                    [__('mail.supplier_report_received.label_report_id'), $referenceId !== '' ? $referenceId : $reportId],
                                    [__('mail.supplier_report_received.label_supplier'), $supplierName],
                                    [__('mail.supplier_report_received.label_reason'), $reasonLabel],
                                ] as [$label, $value])
                                    @if ($value !== null && $value !== '')
                                        <tr>
                                            <td style="padding:0;">
                        ...
                        <tr>
                            <td class="email-pad" bgcolor="#F8F8F8" style="padding:28px 30px;background-color:#F8F8F8;border-bottom:1px solid #F0F0F0;">
                                <table role="presentation" cellspacing="0" cellpadding="0" border="0" style="margin-bottom:18px;border-collapse:separate;">
                                    <tr>
                                        <td width="3" bgcolor="#E8D5A8" style="width:3px;height:18px;background-color:#E8D5A8;border-radius:2px;font-size:0;line-height:0;">&nbsp;</td>
                                        <td style="padding-left:9px;font-weight:500;font-size:17px;line-height:1;font-family:'Lora',Georgia,'Times New Roman',serif;color:#3B2800;">{{ __('mail.supplier_report_received.details_heading') }}</td>
                                    </tr>
                                </table>
                    ...
                    {{-- <tr>
                        <td class="email-pad" bgcolor="#FFFFFF" style="padding:26px 30px 30px;background-color:#FFFFFF;">
                            <table role="presentation" cellspacing="0" cellpadding="0" border="0" style="border-collapse:separate;">
                                <tr>
                                    <td bgcolor="#3B2800" style="border-radius:8px;background-color:#3B2800;">
                                        <a href="{{ $ctaUrl }}"
                                            style="display:inline-block;padding:14px 30px;background-color:#3B2800;color:#FFFFFF;font-weight:900;font-size:12px;line-height:1;font-family:'Nunito',Arial,Helvetica,sans-serif;letter-spacing:0.6px;text-transform:uppercase;text-decoration:none;border-radius:8px;">{{ __('mail.supplier_report_received.cta') }}</a>
                                    </td>
                                </tr>
                            </table>
                            <p style="margin:18px 0 0 0;padding-top:18px;border-top:1px solid #F0F0F0;font-weight:400;font-size:12px;line-height:1.75;font-family:'Nunito',Arial,Helvetica,sans-serif;color:#8A8A8A;">
                                {{ __('mail.supplier_report_received.cta_note') }}
                            </p>
                        </td>
                    </tr> --}}
                        ...
                        <td class="email-pad" bgcolor="#F8F8F8" style="padding:18px 30px;background-color:#F8F8F8;border-top:1px solid #E6E6E6;">
                            <table role="presentation" width="100%" cellspacing="0" cellpadding="0" border="0">
                                <tr>
                                    ...
                                    <td class="email-footer-tag" align="right" style="font-weight:700;font-size:8px;line-height:1;font-family:'Nunito',Arial,Helvetica,sans-serif;letter-spacing:0.8px;text-transform:uppercase;color:#B4B4B4;">{{ __('mail.supplier_report_received.footer_tag') }}</td>
                                </tr>
                            </table>
                            ...
                            <span style="font-weight:600;font-size:10.5px;line-height:1;font-family:'Nunito',Arial,Helvetica,sans-serif;color:#8A8A8A;">{{ __('mail.supplier_report_received.footer') }}</span>
