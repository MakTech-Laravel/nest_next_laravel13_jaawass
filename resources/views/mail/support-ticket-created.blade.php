...
<head>
    ...
    <title>Your support ticket has been received — {{ $ticketNumber }}</title>
    <!--[if mso]>
    <noscript>
        <xml>
    ...
    <style type="text/css">
        ...
        @media (prefers-color-scheme: dark) {
            body, .email-bg-main { background-color: #F4F0EA !important; color: #464646 !important; }
...
<body class="email-bg-main" style="margin:0;padding:0;background-color:#F4F0EA;font-family:Arial,Helvetica,sans-serif;-webkit-text-size-adjust:100%;-ms-text-size-adjust:100%;">
    <div style="display:none;font-size:1px;line-height:1px;max-height:0;max-width:0;opacity:0;overflow:hidden;mso-hide:all;">
        Your support ticket has been received — {{ $ticketNumber }}&nbsp;&zwnj;&nbsp;&zwnj;&nbsp;&zwnj;&nbsp;&zwnj;&nbsp;&zwnj;&nbsp;&zwnj;&nbsp;&zwnj;&nbsp;&zwnj;&nbsp;&zwnj;&nbsp;&zwnj;
    </div>
        ...
        <tr>
            <td align="center" class="email-outer" style="padding:24px 12px;">
                <table role="presentation" width="700" cellspacing="0" cellpadding="0" border="0" class="email-card"
                                ...
                                <tr>
                                    ...
                                    <td class="email-stack" valign="middle">
                                            ...
                                            <tr>
                                                <td>
                                                    <span style="display:inline-block;padding:4px 11px;border-radius:20px;border:1.5px solid #E8D5A8;background-color:#FBF7EE;">
                                                        ...
                                                        <span style="font-weight:800;font-size:8.5px;line-height:1;font-family:Arial,Helvetica,sans-serif;letter-spacing:1.2px;text-transform:uppercase;color:#666666;vertical-align:middle;">Ticket Opened</span>
                                                    </span>
                                                </td>
                                            </tr>
                                        </table>
                                        <div class="email-hero-title email-brand-text"
                                            ...
                                            Your support ticket <em style="font-style:italic;color:#9A7A3A;">has been received.</em>
                                        </div>
                                        <div class="email-body-text" style="padding-top:6px;font-weight:400;font-size:13px;line-height:1.78;font-family:Arial,Helvetica,sans-serif;color:#666666;">
                                            We have received your request and the support team will review it shortly.
                                        </div>
                                    </td>
                                </tr>
                            </table>
                        ...
                        <td class="email-pad email-pad-white" bgcolor="#FFFFFF" style="padding:28px 30px;background-color:#FFFFFF;border-bottom:1px solid #F0F0F0;">
                            <table role="presentation" cellspacing="0" cellpadding="0" border="0" style="margin-bottom:18px;">
                                <tr>
                                    ...
                                    <td class="email-brand-text" style="padding-left:9px;font-weight:500;font-size:17px;line-height:1;font-family:Georgia,'Times New Roman',serif;color:#3B2800;">Ticket details</td>
                                </tr>
                            </table>
                                    ...
                                    <td bgcolor="#F8F8F8" style="padding:11px 16px;background-color:#F8F8F8;border-bottom:1px solid #E6E6E6;">
                                        <table role="presentation" width="100%" cellspacing="0" cellpadding="0" border="0">
                                            <tr>
                                                ...
                                                <td align="right">
                                                    <span style="display:inline-block;padding:2px 10px;border-radius:20px;border:1.5px solid #E8D5A8;background-color:#FBF7EE;font-weight:800;font-size:9px;line-height:1;font-family:Arial,Helvetica,sans-serif;color:#9A7A3A;">Open</span>
                                                </td>
                                            </tr>
                                        </table>
                                    </td>
                    ...
                    <tr>
                        <td class="email-pad" bgcolor="#F8F8F8" style="padding:28px 30px;background-color:#F8F8F8;border-bottom:1px solid #F0F0F0;">
                            ...
                            <p class="email-body-text" style="margin:0 0 13px 0;font-weight:400;font-size:13.5px;line-height:1.88;font-family:Arial,Helvetica,sans-serif;color:#464646;">
                                Your support ticket has been successfully submitted to sourceNest. Our team will review your request and get back to you as soon as possible.
                            </p>
                            <p class="email-body-text" style="margin:0;font-weight:400;font-size:13.5px;line-height:1.88;font-family:Arial,Helvetica,sans-serif;color:#464646;">
                                You can follow the status of your ticket, read replies from our team, and respond directly from the ticket page.
                            </p>
                            ...
                            <table role="presentation" width="100%" cellspacing="0" cellpadding="0" border="0"
                                ...
                                <tr>
                                    <td style="padding:14px 16px;">
                                        <div style="font-weight:900;font-size:8.5px;line-height:1;font-family:Arial,Helvetica,sans-serif;letter-spacing:1.6px;text-transform:uppercase;color:#9A7A3A;margin-bottom:5px;">What to expect</div>
                                        <div style="font-weight:400;font-size:13px;line-height:1.65;font-family:Arial,Helvetica,sans-serif;color:#464646;">
                                            Support is handled by the sourceNest admin team. Response times may vary. You will receive an email notification as soon as there is a reply on your ticket.
                                        </div>
                                    </td>
                                </tr>
                            </table>
                    ...
                    {{-- CTA --}}
                    <tr>
                        <td class="email-pad email-pad-white" bgcolor="#FFFFFF" style="padding:26px 30px 30px;background-color:#FFFFFF;border-top:1px solid #F0F0F0;">
                            <table role="presentation" cellspacing="0" cellpadding="0" border="0">
                                <tr>
                            ...
                            <p style="margin:18px 0 0 0;padding-top:18px;border-top:1px solid #F0F0F0;font-weight:400;font-size:12px;line-height:1.75;font-family:Arial,Helvetica,sans-serif;color:#8A8A8A;">
                                Log in to sourceNest to view your ticket and follow the conversation.
                            </p>
                        </td>
                    </tr>
