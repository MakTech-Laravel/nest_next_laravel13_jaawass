@php
    ...
    $heroIconUrl = public_url('images/mail/svg/order-cancelled-hero.svg');
    ...
    $tx = static fn (string $key, array $replace = []) => __("mail.order_cancelled.admin.{$key}", $replace);
    $shared = static fn (string $key, array $replace = []) => __("mail.order_cancelled.{$key}", $replace);
    $txReplace = [
        'name' => $recipientName,
    ...
    $ctaUrl = $ctaUrl ?? $ordersUrl ?? \App\Support\Mail\MailNotificationHelper::adminOrderUrl($resolvedOrderId);
    $supportUrl = $supportUrl ?? \App\Support\Mail\MailNotificationHelper::adminSupportUrl();
@endphp
<!DOCTYPE html>
                ...
                <table role="presentation" width="700" cellspacing="0" cellpadding="0" border="0"
                            ...
                            <table role="presentation" width="100%" cellspacing="0" cellpadding="0" border="0">
                                <tr>
                                    <td align="left" valign="middle">
                                        @if (! empty($logoUrl))
                                            <a href="{{ $frontendUrl }}?source=email" target="_blank"
                                                style="text-decoration:none;display:inline-block;">
                                                <img src="{{ $logoUrl }}" alt="{{ $platformName }}" width="160"
                                                    height="48"
                                        ...
                                        @else
                                            <a href="{{ $frontendUrl }}?source=email" target="_blank"
                                                ...
                                                <span
                                                    style="font-weight:900;font-size:21px;line-height:1;font-family:Arial,Helvetica,sans-serif;color:#3B2800;letter-spacing:-0.6px;">sourcenest</span>
                                            </a>
                                        @endif
                                    </td>
                                </tr>
                                        ...
                                        <table role="presentation" cellspacing="0" cellpadding="0" border="0" style="border-collapse:separate;">
                                            <tr>
                                                <td width="58" height="58" align="center" valign="middle"
                                                    bgcolor="#C42828"
                                                    style="width:58px;height:58px;background-color:#C42828;border:1.5px solid #C42828;border-radius:14px;">
                                                    @if (! empty($heroIconUrl))
                                                        <img src="{{ $heroIconUrl }}" width="26" height="26"
                                    ...
                                    <td class="email-stack" valign="middle">
                                        <table role="presentation" cellspacing="0" cellpadding="0" border="0"
                                            ...
                                            <tr>
                                                <td>
                                                    <span
                                                        style="display:inline-block;padding:4px 11px;border-radius:20px;border:1.5px solid #EEAAAA;background-color:#FEF2F2;">
                                                        <span
                                                            style="display:inline-block;width:5px;height:5px;border-radius:50%;background-color:#C42828;vertical-align:middle;margin-right:5px;">&nbsp;</span>
                                                        <span
                                                            style="font-weight:800;font-size:8.5px;line-height:1;font-family:Arial,Helvetica,sans-serif;letter-spacing:1.2px;text-transform:uppercase;color:#666666;vertical-align:middle;">{{ $tx('pill') }}</span>
                                                    </span>
                                                </td>
                                            </tr>
                                        </table>
                                        <div class="email-hero-title"
                                            style="font-weight:500;font-size:22px;line-height:1.17;font-family:Georgia,'Times New Roman',serif;color:#7A1818;letter-spacing:-0.2px;">
                                    ...
                                    <td bgcolor="#F8F8F8"
                                        ...
                                        <table role="presentation" width="100%" cellspacing="0" cellpadding="0"
                                            ...
                                            <tr>
                                                ...
                                                <td align="right">
                                                    <span
                                                        style="display:inline-block;padding:2px 10px;border-radius:20px;border:1.5px solid #EEAAAA;background-color:#FEF2F2;font-weight:800;font-size:9px;line-height:1;font-family:Arial,Helvetica,sans-serif;color:#7A1818;">{{ $shared('status_cancelled') }}</span>
                                                </td>
                                            </tr>
                                        </table>
                                    </td>
                    ...
                    <tr>
                        <td class="email-pad" bgcolor="#FFFFFF" style="padding:26px 30px 30px;background-color:#FFFFFF;">
                            ...
                            <p
                                style="margin:18px 0 0 0;padding-top:18px;border-top:1px solid #F0F0F0;font-weight:400;font-size:12px;line-height:1.75;font-family:Arial,Helvetica,sans-serif;color:#8A8A8A;">
                                {{ $tx('cta_note') }}</p>
                        </td>
                    </tr>
                    ...
                    <tr>
                        <td class="email-pad" bgcolor="#F8F8F8"
                            ...
                            <span
                                style="font-weight:600;font-size:10.5px;line-height:1;font-family:Arial,Helvetica,sans-serif;color:#8A8A8A;">{{ $shared('footer_automated') }}</span>
                            <span style="font-size:9px;color:#D6D6D6;margin:0 5px;">·</span>
                            <span
                                style="font-weight:600;font-size:10.5px;line-height:1;font-family:Arial,Helvetica,sans-serif;color:#8A8A8A;">{{ $supportEmail }}</span>
                        </td>
                    </tr>
