@php
    ...
    $heroIconUrl = public_url('images/mail/svg/order-ready-shipment-hero.svg');
    ...
    $tx = static fn (string $key, array $replace = []) => __("mail.order_ready_for_shipment.buyer.{$key}", $replace);
    $shared = static fn (string $key, array $replace = []) => __("mail.order_ready_for_shipment.{$key}", $replace);
    $txReplace = [
        'name' => $recipientName,
                                    ...
                                    <td class="email-stack" valign="middle">
                                        <table role="presentation" cellspacing="0" cellpadding="0" border="0"
                                            ...
                                            <tr>
                                                <td>
                                                    <span
                                                        style="display:inline-block;padding:4px 11px;border-radius:20px;border:1.5px solid #6ECFA0;background-color:#EAFAF2;">
                                                        <span
                                                            style="display:inline-block;width:5px;height:5px;border-radius:50%;background-color:#0E8A4A;vertical-align:middle;margin-right:5px;">&nbsp;</span>
                                                        <span
                                    ...
                                    <td bgcolor="#F8F8F8"
                                        ...
                                        <table role="presentation" width="100%" cellspacing="0" cellpadding="0"
                                            ...
                                            <tr>
                                                ...
                                                <td align="right">
                                                    <span
                                                        style="display:inline-block;padding:2px 10px;border-radius:20px;border:1.5px solid #F0C040;background-color:#FFF8E4;font-weight:800;font-size:9px;line-height:1;font-family:Arial,Helvetica,sans-serif;color:#7A4D00;">{{ $shared('status_ready_for_shipment') }}</span>
                                                </td>
                                            </tr>
                                        </table>
                                    </td>
