@php
    ...
    $heroIconUrl = public_url('images/mail/svg/order-shipped-hero.svg');
    ...
    $tx = static fn (string $key, array $replace = []) => __("mail.order_shipped.buyer.{$key}", $replace);
    $shared = static fn (string $key, array $replace = []) => __("mail.order_shipped.{$key}", $replace);
    $txReplace = [
        'name' => $recipientName,
                                    ...
                                    <td bgcolor="#F8F8F8"
                                        ...
                                        <table role="presentation" width="100%" cellspacing="0" cellpadding="0"
                                            ...
                                            <tr>
                                                ...
                                                <td align="right">
                                                    <span
                                                        style="display:inline-block;padding:2px 10px;border-radius:20px;border:1.5px solid #6ECFA0;background-color:#EAFAF2;font-weight:800;font-size:9px;line-height:1;font-family:Arial,Helvetica,sans-serif;color:#0A5C32;">{{ $shared('status_shipped') }}</span>
                                                </td>
                                            </tr>
                                        </table>
                                    </td>
