@php
    ...
    $tx = static fn (string $key, array $replace = []) => __("mail.order_cancelled.buyer.{$key}", $replace);
    ...
    $ctaUrl = $ctaUrl ?? $ordersUrl ?? \App\Support\Mail\MailNotificationHelper::buyerOrderUrl($resolvedOrderId);
    $supportUrl = $supportUrl ?? \App\Support\Mail\MailNotificationHelper::buyerSupportUrl();
@endphp
<!DOCTYPE html>
