@php
    ...
    $heroIconUrl = public_url('images/mail/svg/order-production-hero.svg');
    ...
    $tx = static fn (string $key, array $replace = []) => __("mail.order_in_production.buyer.{$key}", $replace);
    $shared = static fn (string $key, array $replace = []) => __("mail.order_in_production.{$key}", $replace);
    $txReplace = [
        'name' => $recipientName,
                                    ...
                                    <td bgcolor="#F8F8F8"
                                        ...
                                        <table role="presentation" width="100%" cellspacing="0" cellpadding="0"
                                            ...
                                            <tr>
                                                ...
                                                <td align="right">
                                                    <span
                                                        style="display:inline-block;padding:2px 10px;border-radius:20px;border:1.5px solid #F0C040;background-color:#FFF8E4;font-weight:800;font-size:9px;line-height:1;font-family:Arial,Helvetica,sans-serif;color:#7A4D00;">{{ $shared('status_in_production') }}</span>
                                                </td>
                                            </tr>
                                        </table>
                                    </td>
