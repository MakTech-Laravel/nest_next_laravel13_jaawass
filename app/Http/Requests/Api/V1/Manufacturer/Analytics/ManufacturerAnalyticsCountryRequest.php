...
class ManufacturerAnalyticsCountryRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return array_merge($this->periodRules(), [
            ...
            'order_by' => ['sometimes', 'string', Rule::in(['country', 'buyers', 'percentage'])],
    ...
    {
        return $this->input('order_by', 'percentage');
    }
}
